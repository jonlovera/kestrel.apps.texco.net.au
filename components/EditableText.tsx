...
export default function EditableText({
  ...
  return (
    <input
      ...
      className={`border border-dashed border-current/40 bg-transparent px-1 outline-none focus:border-solid focus:border-brand-orange disabled:opacity-50 ${className} ${inputClassName}`}
    />
  );
}
